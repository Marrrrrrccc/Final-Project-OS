...
public class CPU_Scheduling {
	...
	static void ShortestRemainingTimeFirst() {
		...
		for (i = 0; i < n; i++) {
			...
			System.out.println("P" + (i + 1) + "\t\t" + arrivalTime[i] + "\t\t" + tempBurstTime[i] + "\t\t"
	...
	static void RR() {
		...
		System.out.println("\nAverage waiting time = " + wait_time_total);
	...
	public static void pPrio() {
		...
		for (i = 0; i < n; i++) {
			...
			System.out.println("P" + (i + 1) + "\t\t" + arrivalTime[i] + "\t\t" + tempBurstTime[i] + "\t\t"
					+ priority[i] + "\t\t" + turnAroundTime[i] + "\t\t" + waitingTime[i]);
		}
	...
	static void fcfs() {
		...
		System.out
				.println("Processes | " + "Arrival Time | " + "Burst Time | " + "Turn Around Time | " + "Waiting Time");
	...
	static void sjf() {
		...
		while (a) {
			int c = n, min = 999;
			if (tot == n)
				break; // total no of process = completed process loop will be terminated
